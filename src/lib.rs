// src/lib.rs
/*
 * Core library for BlockchainGate
 */
...
#[derive(Debug)]
pub struct BlockchainGateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockchainGateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockchainGate processing");
    
    let mut processor = BlockchainGateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockchainGateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockchainGateProcessor::new(false);
